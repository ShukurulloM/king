...
const Project = () => {
  ...
  // Har bir tarjima bilan local projectni birlashtiramiz:
  const combinedProjects = translatedProjects.map((tProj, idx) => ({
    ...tProj,
    ...localProjects[idx],
  }));
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mt-16 md:mt-20">
          <div className="inline-flex items-center gap-4 bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-2xl px-6 py-4">
            ...
            <p className="text-gray-300 text-lg">{t("project.more")}</p>
            <div className="w-2 h-2 bg-teal-500 rounded-full animate-pulse"></div>
          </div>
        </div>
      </div>
